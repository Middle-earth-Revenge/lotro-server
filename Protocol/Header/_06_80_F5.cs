...
{
    public class _06_80_F5:Protocol.Generic.ObjectHeader
    {

        private byte[] start = new byte[] { 0x01, 0x02, 0x03, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06 };

        public override byte[] ident {

            get { return new byte[] { 0x80, 0xF5 }; }
        }
